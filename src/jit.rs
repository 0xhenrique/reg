...
fn compile_bytecode(
    ...
    let tag_nil = builder.ins().iconst(types::I64, 0x7FFC_0000_0000_0000u64 as i64);
    let tag_int = builder.ins().iconst(types::I64, 0x7FFD_0000_0000_0000u64 as i64);
    let tag_true = builder.ins().iconst(types::I64, 0x7FFC_0000_0000_0002u64 as i64);
    let tag_false = builder.ins().iconst(types::I64, 0x7FFC_0000_0000_0001u64 as i64);
...
mod tests {
    ...
    // NOTE: Loop compilation requires proper SSA handling which will be addressed in Phase 2.
    // For now, the JIT handles simple straight-line code and forward branches.
    // Loops are detected but require block parameter passing for SSA correctness.
}
